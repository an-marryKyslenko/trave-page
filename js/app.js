(() => {
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            ...
            const pickerStart = datepicker_min(".inputs__date-one", {
                id: "date",
            ...
            const pickerEnd = datepicker_min(".inputs__date-two", {
                id: "date",
                formatter: (input, date, instance) => {
                    const value = date.toLocaleDateString("en-GB", options);
                    input.value = value;
            ...
            pickerEnd.getRange();
            modules_flsModules.datepicker = pickerStart;
            modules_flsModules.datepicker = pickerEnd;
        }
        ...
        function initSliders() {
            if (document.querySelector(".fullscrin__swiper")) {
                new core(".fullscrin__swiper", {
            ...
            if (document.querySelector(".offer__swiper")) {
                new core(".offer__swiper", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    watchSlidesProgress: true,
            ...
            if (document.querySelector(".swiper-trip")) {
                new core(".swiper-trip", {
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    watchOverflow: true,
            ...
            if (document.querySelector(".gallery__collection")) {
                new core(".gallery__collection", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    watchSlidesProgress: true,
            ...
            if (document.querySelector(".exper-container__swiper")) {
                new core(".exper-container__swiper", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
